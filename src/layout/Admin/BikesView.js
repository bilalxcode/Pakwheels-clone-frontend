...
function BikesView() {
  ...
  const handleApproveAdClick = async (bikeId) => {
    // Implement your logic for approving the ad here using the bikeId
    console.log("Approve Ad clicked for bike ID:", bikeId);
    setIsLoading(true);
    try {
  ...
  const handleDeleteClick = async (bikeId) => {
    // Implement your logic for deleting the ad here using the bikeId
    console.log("Delete clicked for bike ID:", bikeId);
    setIsLoading(true);
    try {
      const response = await axios.post(
